...
export default function ServicesPage() {
  return <main><SiteHeader />
    <section className="page-banner"><p className="eyebrow">Houston moving labor</p><h1>The help<br /><em>your move needs.</em></h1><p>You provide the truck or container. Rashad provides practical labor, essential moving gear, and a straight answer about the job.</p><a className="button button-primary" href="/#booking">Request a move <ArrowDownRight size={18} /></a></section>
    ...
    <section className="simple-cta"><div><p className="eyebrow">Straight-up pricing</p><h2>$50/hour.<br />Labor only.</h2></div><div><p>No truck included. Your move date is only booked after Rashad confirms it directly.</p><a className="button button-primary" href="/#booking">Check availability <ArrowDownRight size={18} /></a></div></section>

  ...
  return (
    <>
      <div className="utility-bar">
        <div><span><MapPin size={13} /> Houston & nearby communities</span><span>Moving truck & equipment available</span></div>
  ...
  return (
    <footer className="site-footer">
      <div className="footer-lead">
        <a className="brand footer-brand" href="/"><span>Rashad the Helper</span></a>
